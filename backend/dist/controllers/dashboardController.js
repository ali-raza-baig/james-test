...
export const getDashboardOverview = async (req, res) => {
    try {
        const [totalProperties, residentialProperties, commercialProperties, latestProperties, totalBlogs, latestBlogs, totalEnquiries, recentEnquiries, totalSubscribers, totalContacts, recentContacts, totalTestimonials] = await Promise.all([
